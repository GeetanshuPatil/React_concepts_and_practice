  ...
  let handleChange = (e) => {
    ...
    timerId = setTimeout(() => {
      let newData = data.filter((obj) =>
        obj.title.toLowerCase().includes(searchVal.toLowerCase())
      );
      ...
      <div className="w-full max-w-lg bg-white p-6 rounded-xl shadow-lg">
        ...
        <div className="flex gap-3 mb-6">
          <input
            ...
            className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition"
          />
          <button
            onClick={handleClick}
        ...
        <div className="space-y-3">
          {product.map((obj) => (
            ...
            >
              ...
              <p className="text-gray-800 font-medium">{obj.title}</p>
              <p>{obj.price}</p>
            </div>
          ))}
        </div>
